package org.well.test.husky.util;

import java.util.regex.Pattern;

/**
 * @ClassName:InetAddressUtils
 * @Description:网络地址相关工具类
 * @author well
 * @date:2020年4月8日
 *
 */
public class InetAddressUtils {
    ...
    public static boolean isIPv4MappedIPv6Address(final String input) {
     ...
     *
     * @param input the address string to check for validity
     * @return true if the input parameter is a valid IPv6 address (including compressed).
     */
